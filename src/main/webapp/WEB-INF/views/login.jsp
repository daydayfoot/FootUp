...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	<script type="text/javascript" src="${fts }/resources/js/jquery.js"></script>
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                <form method="post"  id="loginForm">
                    ...
                    <input type="text" class="form-control uname" placeholder="用户名"  id="account"  name="account"/>
                    <input type="password" class="form-control pword m-b" placeholder="密码"  id="password"  name="password"/>
<!--                     <a href="default.htm">忘记密码了？</a> -->
                    <span class="btn btn-success btn-block" onclick="loginSubmit()">登录</span>
                </form>
            </div>
        </div>
